...
const CartTable = ({form}) => {
    ...
    return (
        <Fragment>
            <Modal title="Add your address. Please, confirm before clicking 'ok' " visible={visible} onOk={handleOk} onCancel={handleCancel}>
        ...
        <div className="checkoutBox col-md-4">
            <Affix offsetTop={50}>
            <h1>Total: ₦7800</h1>
                <button class="btn btn-danger" onClick={showModal}>Proceed to checkout</button>
            </Affix>
        </div>
        </div>
        </Fragment>
